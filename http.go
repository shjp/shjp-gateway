...
func SendResponse(w http.ResponseWriter, body string, statusCode int) {
	...
	w.Header().Set("Access-Control-Allow-Headers", "X-Requested-With,Content-Type,Authorization,Auth-Token")
	w.Header().Set("Access-Control-Allow-Methods", "GET,PUT,POST,DELETE,OPTIONS,PING")
